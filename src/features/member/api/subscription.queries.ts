...
import { subscriptionApi, Subscription, CreateSubscriptionRequest, UpdateSubscriptionRequest } from './subscription.api';
...
export const useCreateSubscription = () => {
  ...
  return useMutation({
    mutationFn: (data: CreateSubscriptionRequest) => subscriptionApi.createSubscription(data),
