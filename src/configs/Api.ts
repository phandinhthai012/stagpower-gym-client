...
export const API_ENDPOINTS = {
    ...
    DISCOUNT_TYPE: {
        GET_ALL_DISCOUNT_TYPES: `${API_PREFIX}/discount-types`,
        GET_DISCOUNT_TYPE_BY_ID: (discountTypeId: string) => `${API_PREFIX}/discount-types/${discountTypeId}`,
        CREATE_DISCOUNT_TYPE: `${API_PREFIX}/discount-types`,
        UPDATE_DISCOUNT_TYPE: (discountTypeId: string) => `${API_PREFIX}/discount-types/${discountTypeId}`,
        DELETE_DISCOUNT_TYPE: (discountTypeId: string) => `${API_PREFIX}/discount-types/${discountTypeId}`,
    },
    AI_SUGGESTION: {
